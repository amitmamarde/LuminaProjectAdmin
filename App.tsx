...
const firebaseConfig = {
  apiKey: process.env.API_KEY, // Handled by the environment
  authDomain: "lumina-misinfo-app.firebaseapp.com",
  projectId: "lumina-misinfo-app",
  storageBucket: "lumina-misinfo-app.appspot.com",
