 ...
 */
exports.generateArticleContent = onDocumentCreated("articles/{articleId}", async (event) => {
  // Lazily initialize the GenAI client inside the function
  // to ensure the API key parameter is resolved at runtime.
